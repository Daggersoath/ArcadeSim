...
set_config_specific_property("OUTPUT_DIRECTORY" "${CMAKE_SOURCE_DIR}$<$<NOT:$<STREQUAL:${CMAKE_PLATFORM_ARCHITECTURE},Win32>>:/${CMAKE_PLATFORM_ARCHITECTURE}>/${PROPS_CONFIG}")
